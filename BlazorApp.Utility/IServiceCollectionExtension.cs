...
namespace BlazorApp.Utility
{
    ...
    public static class IServiceCollestionExtension
    {
        ...
        public static IServiceCollection InjectUtilityServices(this IServiceCollection services, IConfiguration Configuration)
        {
            #region Initialize MailSender
            ...
            services.AddSingleton<IMailService, MailSender>();
            #endregion
